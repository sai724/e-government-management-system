...
String query="select * from elecdata";
ResultSet rs=st.executeQuery(query);
out.println("<br><h1><br><center><b><u>PROBLEMS OF ELECTRICITY DEPARTMENT<b></center></u><br>");
%>
...
<form action="deleteelec.jsp" method="post">
